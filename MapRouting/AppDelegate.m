...
- (void)setupViewController {
    ...
    MapRoutingViewController *homeVC = [[MapRoutingViewController alloc] initWithNibName:@"MapRoutingViewController" bundle:nil];
    MapRoutingViewModel *viewModel = [[MapRoutingViewModel alloc] init];
